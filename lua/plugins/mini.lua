local base16 = function()
  require('mini.base16').setup({
    palette = {
      ...
      base02 = "#636D83", -- Selection
      base03 = "#274670", -- Comments
      base04 = "#ABB2BF", -- Foreground
      base05 = "#F9C859", -- Keywords; Statusline 'Normal mode'
      base06 = "#50ACAE", -- Strings
      base07 = "#3691FF", -- Types
      base08 = "#FF6480", -- Methods; Lazygit Removal
      base09 = "#9F7EFE", -- Constants
      base0A = "#7A82DA", -- Punctuation
      base0B = "#3FC56B", -- Tags; Lazygit Addition
